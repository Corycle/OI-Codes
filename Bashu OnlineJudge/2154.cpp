...
void Shift(int x,int y){
	...
	if(t1==0&&t2==0){//1.1
		...
		if(x<n&&Check(x,y)&&indep<2)Update(s1+3*p1);
		if(y<m&&Check(x,y)&&indep<2)Update(s1+3*p2);
	}
	...
	if(t1>0&&t2==0){//3.1
		...
		if(t1==1&&indep<2&&Check(x,y)){//3.1.1
			int i=Get_I1(y);
			Update(s1-t1*p1+a[i-1]);
		}
		if(t1==2&&indep<2&&Check(x,y)){//3.1.2
			int i=Get_I2(y);
	...
	if(t1==0&&t2>0){//3.2
		...
		if(t2==1&&indep<2&&Check(x,y)){//3.2.1
			int i=Get_I1(y);
			Update(s1-t2*p2+a[i-1]);
		}
		if(t2==2&&indep<2&&Check(x,y)){//3.2.2
			int i=Get_I2(y);
